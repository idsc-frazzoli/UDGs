...
def _dynamics_car(x, u, p, n):
    ...
    for k in range(n):
        ...
        dx[params.s_idx.CumSlackCost + upd_s_idx] = kSlack * slack + kSlack * slack_coll + kSlack * slack_obs + lagcost
        dx[params.s_idx.CumLatSpeedCost + upd_s_idx] = speedcostM + leftLaneCost + lagcost
