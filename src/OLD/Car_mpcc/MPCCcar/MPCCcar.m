% MPCCcar - a fast solver generated by FORCES PRO v4.1.1
%
%   OUTPUT = MPCCcar(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = MPCCcar(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = MPCCcar(PARAMS) returns 
