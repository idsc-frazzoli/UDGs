...
from udgs.forces_models.model_def.generate_model import AVAILABLE_METHODS, generate_forces_models, SolutionMethod, LexicographicPG
...
def main(generate_solver: bool = True,
    ...
    report.to_html("udgs_report.html")
